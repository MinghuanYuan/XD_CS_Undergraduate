...
void DrawCurve(int n)
{
	...
	glBegin(GL_LINE_STRIP);
		for(i=0;i<n;i++)
		{
			...
			t3 = t*t2;
			dis3 = dis*dis2;
			p.x = dis3*Points[0].x+3*t*dis2*Points[1].x+3*t2*dis*Points[2].x+t3*Points[3].x;
			p.y = dis3*Points[0].y+3*t*dis2*Points[1].y+3*t2*dis*Points[2].y+t3*Points[3].y;
			p.z = dis3*Points[0].z+3*t*dis2*Points[1].z+3*t2*dis*Points[2].z+t3*Points[3].z;
